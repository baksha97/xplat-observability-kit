Below is a **draft** `README.md` for my **Capture** library. It follows a style similar to SwiftLog’s documentation and explains the core concepts, usage, and extensibility options. It doesn't exist yet. 
